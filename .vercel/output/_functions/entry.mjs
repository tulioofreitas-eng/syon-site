...
import { A as clientAddressSymbol, C as isRoute500, D as REDIRECT_STATUS_CODES, E as DEFAULT_404_COMPONENT, M as originPathnameSymbol, N as pipelineSymbol, O as REROUTABLE_STATUS_CODES, P as responseSentSymbol$1, S as isRoute404, T as ASTRO_GENERATOR, _ as pushDirective, a as chunkToString, b as renderEndpoint, c as isRenderTemplateResult, d as decryptString, f as generateCspDigest, g as normalizeCspResourceEntry, h as isRenderInstruction, i as renderComponent, j as fetchStateSymbol, k as appSymbol, l as renderTemplate, n as renderPage, o as createSlotValueFromString, r as renderJSX, s as renderSlotToString, u as decodeKey, v as isAstroComponentFactory, w as ASTRO_ERROR_HEADER } from "./chunks/server_K4JWsnKj.mjs";
...
var middlewareSecret = "0cf20b19-90ff-4c7d-a632-2520d40a024c";
//#endregion
...
var _page0 = () => import("./chunks/generic__NWmMmjK.mjs");
var _page1 = () => import("./chunks/lead_CtfmqbaS.mjs");
var pageMap = /* @__PURE__ */ new Map([["node_modules/astro/dist/assets/endpoint/generic.js", _page0], ["src/pages/api/lead.ts", _page1]]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///workspaces/syon-site/","cacheDir":"file:///workspaces/syon-site/node_modules/.astro/","outDir":"file:///workspaces/syon-site/dist/","srcDir":"file:///workspaces/syon-site/src/","publicDir":"file:///workspaces/syon-site/public/","buildClientDir":"file:///workspaces/syon-site/dist/client/","buildServerDir":"file:///workspaces/syon-site/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/lead","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/lead\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"lead","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/lead.ts","pathname":"/api/lead","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/contato","isIndex":false,"type":"page","pattern":"^\\/contato\\/?$","segments":[[{"content":"contato","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/contato.astro","pathname":"/contato","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/empreendimentos/alvin","isIndex":false,"type":"page","pattern":"^\\/empreendimentos\\/alvin\\/?$","segments":[[{"content":"empreendimentos","dynamic":false,"spread":false}],[{"content":"alvin","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/empreendimentos/alvin.astro","pathname":"/empreendimentos/alvin","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/empreendimentos","isIndex":true,"type":"page","pattern":"^\\/empreendimentos\\/?$","segments":[[{"content":"empreendimentos","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/empreendimentos/index.astro","pathname":"/empreendimentos","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/sobre","isIndex":false,"type":"page","pattern":"^\\/sobre\\/?$","segments":[[{"content":"sobre","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/sobre.astro","pathname":"/sobre","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","site":"https://syon-site.example.vercel.app","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/workspaces/syon-site/src/pages/contato.astro",{"propagation":"none","containsHead":true}],["/workspaces/syon-site/src/pages/empreendimentos/alvin.astro",{"propagation":"none","containsHead":true}],["/workspaces/syon-site/src/pages/empreendimentos/index.astro",{"propagation":"none","containsHead":true}],["/workspaces/syon-site/src/pages/index.astro",{"propagation":"none","containsHead":true}],["/workspaces/syon-site/src/pages/sobre.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.DuF2KQd5.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:page:src/pages/empreendimentos/alvin@_@astro":"chunks/alvin_BvlyuaYB.mjs","\u0000virtual:astro:page:src/pages/contato@_@astro":"chunks/contato_PO2sYLAD.mjs","\u0000virtual:astro:page:src/pages/empreendimentos/index@_@astro":"chunks/index_1LrjqCcP.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_Cy9SZC5Q.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","\u0000virtual:astro:page:src/pages/sobre@_@astro":"chunks/sobre_DcJt3pS9.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic__NWmMmjK.mjs","\u0000virtual:astro:page:src/pages/api/lead@_@ts":"chunks/lead_CtfmqbaS.mjs","/workspaces/syon-site/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_CDoBJrzf.mjs","/workspaces/syon-site/src/pages/empreendimentos/alvin.astro?astro&type=script&index=0&lang.ts":"_astro/alvin.astro_astro_type_script_index_0_lang.CzWJUIuK.js","/workspaces/syon-site/src/pages/contato.astro?astro&type=script&index=0&lang.ts":"_astro/contato.astro_astro_type_script_index_0_lang.BpGVRIZk.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["/workspaces/syon-site/src/pages/empreendimentos/alvin.astro?astro&type=script&index=0&lang.ts","async function e(){let e=document.getElementById(`progresso-carregando`),t=document.getElementById(`progresso-vazio`),n=document.getElementById(`progresso-lista`);try{let r=await(await fetch(`undefined/rest/v1/obra_fases_publicas_status?nome_empreendimento=eq.Projeto%20Alvin&order=ordem.asc`,{headers:{apikey:void 0,Authorization:`Bearer undefined`}})).json();if(e.style.display=`none`,!Array.isArray(r)||r.length===0){t.style.display=`block`;return}n.innerHTML=r.map(e=>`\n        <div class=\"progresso-fase\">\n          <span class=\"nome\">${e.nome_fase}</span>\n          <div class=\"progresso-barra\"><div class=\"preenchido\" style=\"width:${e.percentual_concluido}%\"></div></div>\n          <span class=\"percentual\">${e.percentual_concluido}%</span>\n        </div>\n      `).join(``),n.style.display=`flex`,n.style.flexDirection=`column`}catch{e.style.display=`none`,t.style.display=`block`}}e();"],["/workspaces/syon-site/src/pages/contato.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`form-contato`),t=document.getElementById(`status-envio`),n=document.getElementById(`btn-enviar`),r=document.getElementById(`syon-sucesso`);e?.addEventListener(`submit`,async i=>{i.preventDefault();let a=n.textContent;n.disabled=!0,n.textContent=`Enviando...`,t.textContent=``;try{let i=await fetch(`/api/lead`,{method:`POST`,body:new FormData(e)}),o=await i.json();i.ok?(e.reset(),e.style.display=`none`,r.style.display=`block`):(t.textContent=o.error||`Não foi possível enviar. Tenta de novo.`,n.disabled=!1,n.textContent=a)}catch{t.textContent=`Não foi possível enviar. Tenta de novo.`,n.disabled=!1,n.textContent=a}});"]],"assets":["/assets/img/favicon-16.png","/assets/img/favicon-180.png","/assets/img/favicon-192.png","/assets/img/favicon-32.png","/assets/img/favicon-48.png","/assets/img/syon-mark.png","/assets/js/main.js","/assets/css/style.css","/contato/index.html","/empreendimentos/alvin/index.html","/empreendimentos/index.html","/sobre/index.html","/index.html"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"jzSI2RrslHEv78tnmtw5cWda41ZjPsQzSH9eXkK1aDI=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "0cf20b19-90ff-4c7d-a632-2520d40a024c") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
